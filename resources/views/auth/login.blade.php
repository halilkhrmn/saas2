...
<head>
    <meta charset="UTF-8">
    <title>{{ config('app.name', 'API SaaS') }} - Sign In</title>
        ...
        <div class="d-lg-flex text-white min-vh-100" style="background: linear-gradient(180deg,#42404e 0,#1b1e29);">
            ...
            <div class="col-12 col-lg-7 d-lg-flex">
                <div class="w-100 align-self-center text-center-md text-center-xs p-2">
                    <!-- Login Form -->
                    <form novalidate action="{{ route('login') }}" method="POST" class="bs-validate p-5 py-6 rounded d-inline-block bg-white text-dark w-100 max-w-600">
                        @csrf
                        ...
                        <div class="input-group-over">
                            ...
                            <a href="#" class="btn smaller fw-bold">
                                FORGOT?
                            </a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mt-4 text-align-end text-center-xs">
                                <a href="{{ route('register') }}" class="btn px-0 link-normal">
